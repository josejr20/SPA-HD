...
public class DashboardService {
    ...
    public DashboardStatsDTO getDashboardStats() {
        ...
        double ingresosMes = reservasMes.stream()
            ...
            .mapToDouble(r -> r.getService() != null && r.getService().getBaseprice() != null ? r.getService().getBaseprice() : 0.0)
            .sum();
    ...
    public List<MonthlyRevenueDTO> getMonthlyRevenue(int months) {
        ...
        for (int i = months - 1; i >= 0; i--) {
            ...
            String mesNombre = monthStart.getMonth().getDisplayName(TextStyle.FULL, Locale.of("es", "ES"));
