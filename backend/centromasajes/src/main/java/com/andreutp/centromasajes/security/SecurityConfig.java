    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // .requestMatchers("/services/**" ,"/services" ).hasRole("ADMIN")//sigue
                        // pidiendo token si aun esta en permitir todo
                        .requestMatchers("/services/**").permitAll()
                        ...
                        // PLANES
                        // .requestMatchers(HttpMethod.GET, "/plans/**").hasAnyRole("ADMIN", "WORKER",
                        // "USER") // todos pueden ver
                        // .requestMatchers("/plans/**").hasAnyRole("ADMIN", "WORKER") //
                        // crear/editar/eliminar solo WORKER y ADMIN segun necesidad xd
                        ...
                        // "/appointments/**/status").hasRole("WORKER")
                        ...
                        // Accesos para USER
                        // .requestMatchers(HttpMethod.POST, "/appointments").hasRole("USER") // Crear
                        // cita
                        // .requestMatchers(HttpMethod.GET, "/appointments/my").hasRole("USER") // Ver
                        // sus citas

                        // Accesos para WORKER
                        // .requestMatchers(HttpMethod.GET, "/appointments/worker/**").hasRole("WORKER")
                        // // Ver citas por trabajador
                        // .requestMatchers(HttpMethod.PATCH,
                        // "/appointments/**/status").hasRole("WORKER") // Actualizar estado

                        // Accesos para ADMIN
                        // .requestMatchers(HttpMethod.GET, "/appointments").hasRole("ADMIN") // Listar
                        // todas
                        // .requestMatchers(HttpMethod.PUT, "/appointments/**").hasRole("ADMIN") //
                        // Actualizar completa
                        // .requestMatchers(HttpMethod.DELETE, "/appointments/**").hasRole("ADMIN") //
                        // Eliminar
                        // .requestMatchers(HttpMethod.PATCH,
                        // "/appointments/**/status").hasRole("ADMIN") // También puede cambiar estado

                        // PROMOTIONS
                        // .requestMatchers(HttpMethod.GET, "/promotions/**").hasAnyRole("USER",
                        // "WORKER", "ADMIN") // listar/consultar
                        // .requestMatchers("/promotions/**").hasRole("ADMIN") // crear/editar/eliminar

                        // INVOICE
                        // .requestMatchers(HttpMethod.POST, "/invoices/**").hasRole("USER") // crear
                        // factura
                        // .requestMatchers(HttpMethod.GET, "/invoices/my/**").hasRole("USER") // listar
                        // mis facturas
                        // .requestMatchers("/invoices/**").hasRole("ADMIN") // actualizar, eliminar,
                        // listar todas
